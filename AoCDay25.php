...
$functions[] = 'drop astronaut ice cream';
$functions[] = 'drop hypercube';
$functions[] = 'drop boulder';
$functions[] = 'drop sand';
$functions[] = 'drop antenna';
$functions[] = 'drop mutex';
$functions[] = 'drop spool of cat6';
$functions[] = 'drop mouse';



$functions[] = 'take boulder';
//$functions[] = 'take spool of cat6';
//$functions[] = 'take hypercube'; // Can't include this
//$functions[] = 'take mutex'; // Can't include this
//$functions[] = 'take antenna'; // Can't include this
$functions[] = 'take mouse'; // must be included
$functions[] = 'take sand'; // must be included
$functions[] = 'take astronaut ice cream'; // must be included
...
// Ice cream, Mouse, Antenna are heavy - ice cream is required
// sand, boulder, hypercube, spool of cat6, astronaut ice cream, antenna, mutex, mouse
...
function printGrid($trackGridInputArray) {
 ...
 class processCode {
    ...
    function updateInputReference() {
        if(isset($this->inputCode[$this->inputValueRequest])) {
